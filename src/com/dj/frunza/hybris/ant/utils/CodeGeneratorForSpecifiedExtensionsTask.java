 ...
 * The only big difference is that this class is not deleting models.jar in order to increase the build performance and to avoid the need for hybris restart.
 * <p>
